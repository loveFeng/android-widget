...
public class GlowPadViewActivity extends Activity implements OnTriggerListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_glowpadview);
