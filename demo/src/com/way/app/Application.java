...
public class Application extends android.app.Application {
	...
	private CityDB openCityDB() {
		String path = "/data"
				...
				+ File.separator + /*"com.way.weather"*/ "com.example.demo_highlights" + File.separator
				+ CityDB.CITY_DB_NAME;
	...
	private void initWidgetWeather() {
		...
		mWidgetWeatherIcon.put("多云", R.drawable.w1_moji);
		mWidgetWeatherIcon.put("雷阵雨", R.drawable.w4_moji);
		...
		mWidgetWeatherIcon.put("阴", R.drawable.w2_moji);

		mWidgetWeatherIcon.put("雨夹雪", R.drawable.w6);
		mWidgetWeatherIcon.put("阵雪", R.drawable.w13);
		mWidgetWeatherIcon.put("阵雨", R.drawable.w3_moji);
