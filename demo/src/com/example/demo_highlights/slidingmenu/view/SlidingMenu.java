 ...
 */
package com.example.demo_highlights.slidingmenu.view;
...
public class SlidingMenu extends RelativeLayout {
	...
	public boolean isShowSlidingView() {
		int menuWidth = mMenuView.getWidth();
		int detailWidth = mDetailView.getWidth();
		int oldScrollX = mSlidingView.getScrollX();
		
		if (oldScrollX == -menuWidth || oldScrollX == detailWidth) {
			return true;
		}
	...
	public void closeSlidingView() {
		...
		} else if (oldScrollX == detailWidth) {
			smoothScrollTo(-detailWidth);
			if (hasClickRight) {
				hasClickRight = false;
				setCanSliding(tCanSlideLeft, tCanSlideRight);
			}
