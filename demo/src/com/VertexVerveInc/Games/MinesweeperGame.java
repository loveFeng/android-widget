...
public class MinesweeperGame extends Activity
{
	...
	private int blockDimension = 24 * 2; // width of each block
	private int blockPadding = 2 * 2; // padding between blocks
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.main_saolei);
	...
	private void showMineField()
	{
		...
		for (int row = 1; row < numberOfRowsInMineField + 1; row++)
		{
			...
			mineField.addView(tableRow,new TableLayout.LayoutParams(  
					(blockDimension + 2 * blockPadding) * numberOfColumnsInMineField, (blockDimension + 2 * blockPadding) * 2));  
		}
	}
	...
	private void endExistingGame()
	{
		...
		btnSmile.setBackgroundResource(R.drawable.smile_saolei);
	...
	private void winGame()
	{
		...
		btnSmile.setBackgroundResource(R.drawable.cool_saolei);
	...
	private void finishGame(int currentRow, int currentColumn)
	{
		...
		isTimerStarted = false;
		btnSmile.setBackgroundResource(R.drawable.sad_saolei);
	...
	private void showDialog(String message, int milliseconds, boolean useSmileImage, boolean useCoolImage)
	{
		...
		if (useSmileImage)
		{
			coolImage.setImageResource(R.drawable.smile_saolei);
		}
		else if (useCoolImage)
		{
			coolImage.setImageResource(R.drawable.cool_saolei);
		}
		else
		{
			coolImage.setImageResource(R.drawable.sad_saolei);
		}
